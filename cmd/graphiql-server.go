...
var graphiqlServerCMD = &cobra.Command{
	Use:   "graphiql",
	Short: "start graphiql server",
	Run: func(cmd *cobra.Command, args []string) {
		...
		e.POST("/graphiql", echo.WrapHandler(handler))

		// Start server
		go func() {
			if err := e.Start(viper.GetString("graphiql_server.address")); err != nil && err != http.ErrServerClosed {
